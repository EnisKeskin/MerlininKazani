                ...
                <div class="bildi">
                    ...
                    <div class="tumicerikkonu">
                        <ul>
                            ...
                            <?php for ($i = 0; $i < $contentRowNumspe; $i++) {
                                    if ($i == 20) {
                                        break;
                                    }
                                    ?>
                    ...
                    <div class="sayfa-numarasi">
                        <?php $sayfadeger = url(2);
                        ((url(2) == 1) ? $sayfadeger = url(2) : $sayfadeger--);
                        $deger = ceil(content_num($katego_id) / 20);?>
                        <?php if ($deger < url(2) || url(2) <= 0) {?>
                        <?php }?>
                        <ul>
                            <li>
                                <?php if (url(2) > 1) {?>
                                <a href="<?php echo site_url("konular/" . url(1) . "/" . (url(2) - 1)); ?>">Önceki
                                    Sayfa</a>
                                <?php }?>
                            </li>
                            <?php if ($sayfadeger < 5) {?>
                            ...
                            <?php for ($i = $sayfadeger; $i < ($deger + $sayfadeger); $i++) {?>
                            <?php if ($i <= ($sayfadeger + 2) && !($sayfadeger >= ($deger - 1))) {?>
                            <li>
                                <a href="<?php echo site_url("konular/" . url(1) . "/" . $i); ?>"><?php echo $i ?></a>
                            </li>
                            <?php } else {?>
                            ...
                            <li>
                                <a
                                    href="<?php echo site_url("konular/" . url(1) . "/" . ($deger - 1)); ?>"><?php echo ($deger - 1) ?></a>
                            </li>
                            <li>
                                <a
                                    href="<?php echo site_url("konular/" . url(1) . "/" . $deger); ?>"><?php echo $deger ?></a>
                            </li>
                            <?php }?>
                            <li>
                                <?php if ($deger > url(2)) {?>
                                <a href="<?php echo site_url("konular/" . url(1) . "/" . (url(2) + 1)); ?>">Sonraki
                                    Sayfa</a>
                                <?php }?>
                            </li>
                        </ul>
